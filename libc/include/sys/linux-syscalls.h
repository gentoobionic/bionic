...
#define __NR_pivot_root                   (__NR_SYSCALL_BASE + 117)
...
#define __NR_msgget                       (__NR_SYSCALL_BASE + 186)
#define __NR_msgctl                       (__NR_SYSCALL_BASE + 187)
#define __NR_semget                       (__NR_SYSCALL_BASE + 190)
#define __NR_semctl                       (__NR_SYSCALL_BASE + 191)
#define __NR_semop                        (__NR_SYSCALL_BASE + 193)
#define __NR_shmget                       (__NR_SYSCALL_BASE + 194)
#define __NR_shmctl                       (__NR_SYSCALL_BASE + 195)
#define __NR_shmat                        (__NR_SYSCALL_BASE + 196)
#define __NR_shmdt                        (__NR_SYSCALL_BASE + 197)
...
#define __NR_pivot_root                   (__NR_SYSCALL_BASE + 118)
